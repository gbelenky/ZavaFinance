...
/// <summary>
/// Parses the period supplied by the model-backed finance agent.
/// <para>
/// The model resolves unambiguous inherited/default years; an unparseable or absent range is
...
public static class FinancePeriodParser
{
    ...
    /// deterministic across pending clarification continuations.
    /// </param>
