# Connect zavafinance-one to Microsoft Teams

`azd deploy` already did the Azure side for you:

- Azure Bot: `zavafinance-one-bot-b0c665c8` (Microsoft Teams channel enabled)
- Bot ID (msaAppId): `d0f5008b-84e1-414c-bd2d-f41e86612b47`
